...
allTasks = [[(createsexprgraph, 25, 31)], [], [(logicLgraph, 6, 61), (partfuncLgraph, 2, 31), (minmaxLgraph, 4, 59), 
             (absoluteLgraph, 2, 29), (exprtypeLgraph, 6, 46), (listpropsLgraph, 5, 87)], []]
...
exprtypeLgraph::[Node]
exprtypeLgraph = [Node 1 [(Symb "Реализуйте функцию", [], [], 2)],
                  Node 2 [(Symb ", возвращающую атом empty, если ее аргумент – пустое выражение, атом atom, если он является атомом, и атом list, если – списком. ", [], [Bracket '<' 1], 3),
                          (Symb ". Если ее аргумент – числовой атом, она возвращает результат его ", [], [], 4)],
                  Node 3 [(Symb "Решение должно быть минимальным по числу токенов.", [], [], 6)],
                  ...
                  Node 5 [(Symb "Если символьный атом, результатом является его значение, и NIL иначе. ", [], [], 3)],
                  Node 6 [(Symb "(", [], [], 7)],
                  Node 7 [(Symb "DEFUN", [], [], 8)],
                  Node 8 [(Func 0, [], [], 9)],
                  Node 9 [(Symb "(", [], [], 10)],
                  ...
                  Node 14 [(Symb "(", [], [], 15)],
                  Node 15 [(Symb "(", [], [], 16)],
                  Node 16 [(Symb "NULL", [Bracket '(' 1], [Bracket '>' 1], 17),
                           (Symb "NUMBERP", [Bracket '(' 3, Bracket '(' 2], [], 17),
                           (Symb "SYMBOLP", [Bracket '(' 3], [], 17)],
                  Node 17 [(Var 0, [], [], 18)],
                  Node 18 [(Symb ")", [], [], 19)],
                  Node 19 [(Symb "(", [], [], 20),
                           (Symb "`", [Bracket ')' 1, Bracket '(' 1], [], 23),
                           (Var 0, [Bracket ')' 3, Bracket '(' 2], [], 25)],
                  Node 20 [(Symb "/", [Bracket ')' 2, Bracket '(' 2], [Bracket '>' 5, Bracket '<' 1], 21),
                           (Symb "*", [Bracket ')' 2, Bracket '(' 2], [Bracket '>' 4, Bracket '<' 2], 21),
                           (Symb "-", [Bracket ')' 2, Bracket '(' 2], [Bracket '>' 3, Bracket '<' 1], 21),
                           (Symb "+", [Bracket ')' 2, Bracket '(' 2], [Bracket '>' 2, Bracket '<' 2], 21),
                           (Symb "QUOTE", [Bracket ')' 1, Bracket '(' 1, Bracket '(' 2], [], 23)],
                  Node 21 [(Var 0, [Bracket '(' 1], [Bracket '>' 1], 22),
                           (Var 0, [Bracket '(' 1], [Bracket '>' 2], 22),
                           (Symb "N", [Bracket '(' 2], [Bracket '>' 2], 22)],
                  Node 22 [(Var 0, [Bracket ')' 2], [], 24),
                           (Symb "N", [Bracket ')' 1], [], 24)],
                  Node 23 [(Symb "EMPTY", [], [], 24)],
                  Node 24 [(Symb ")", [Bracket ')' 2], [], 25),
                           (Symb "", [Bracket ')' 1, Bracket '(' 1], [], 25)],
                  Node 25 [(Symb ")", [], [], 26)],
                  Node 26 [(Symb "(", [], [], 27)],
                  Node 27 [(Symb "(", [], [], 28)],
                  Node 28 [(Symb "ATOM", [Bracket ')' 1, Bracket '(' 1], [Bracket '<' 6], 29),
                           (Symb "LISTP", [Bracket ')' 1, Bracket '(' 1], [Bracket '<' 7], 29),
                           (Symb "NUMBERP", [Bracket ')' 2, Bracket '(' 2], [], 29),
                           (Symb "SYMBOLP", [Bracket ')' 3, Bracket '(' 3], [], 29)],
                  Node 29 [(Var 0, [], [], 30)],
                  Node 30 [(Symb ")", [], [], 31)],
                  Node 31 [(Symb "(", [], [], 32),
                           (Symb "`", [Bracket ')' 1, Bracket '(' 1], [], 35),
                           (Var 0, [Bracket ')' 3, Bracket '(' 2], [], 37)],
                  Node 32 [(Symb "/", [Bracket ')' 2, Bracket '(' 2, Bracket '(' 2], [Bracket '>' 5, Bracket '<' 1], 33),
                           (Symb "*", [Bracket ')' 2, Bracket '(' 2, Bracket '(' 2], [Bracket '>' 4, Bracket '<' 2], 33),
                           (Symb "-", [Bracket ')' 2, Bracket '(' 2, Bracket '(' 2], [Bracket '>' 3, Bracket '<' 1], 33),
                           (Symb "+", [Bracket ')' 2, Bracket '(' 2, Bracket '(' 2], [Bracket '>' 2, Bracket '<' 2], 33),
                           (Symb "QUOTE", [Bracket ')' 1, Bracket '(' 1, Bracket '(' 2], [], 35)],
                  Node 33 [(Var 0, [Bracket '(' 1], [Bracket '>' 1], 34),
                           (Var 0, [Bracket '(' 1], [Bracket '>' 2], 34),
                           (Symb "N", [Bracket '(' 2], [Bracket '>' 2], 34)],
                  Node 34 [(Var 0, [Bracket ')' 2], [], 36),
                           (Symb "N", [Bracket ')' 1], [], 36)],
                  Node 35 [(Symb "ATOM", [], [Bracket '>' 6, Bracket '<' 7], 36),
                           (Symb "LIST", [], [Bracket '>' 7, Bracket '<' 6], 36)],
                  Node 36 [(Symb ")", [Bracket ')' 2], [], 37),
                           (Symb "", [Bracket ')' 1, Bracket '(' 1], [], 37)],
                  Node 37 [(Symb ")", [], [], 38)],
                  Node 38 [(Symb "(", [Bracket ')' 1], [], 39),
                           (Symb "", [Bracket ')' 2], [], 44)],
                  Node 39 [(Symb "(", [Bracket '(' 2], [], 40),
                           (Symb "`", [Bracket '(' 1], [], 41)],
                  Node 40 [(Symb "QUOTE", [], [], 41)],
                  Node 41 [(Symb "ATOM", [], [Bracket '>' 6], 42),
                           (Symb "LIST", [], [Bracket '>' 7], 42)],
                  Node 42 [(Symb ")", [Bracket ')' 2], [], 43),
                           (Symb "", [Bracket ')' 1], [], 43)],
                  Node 43 [(Symb ")", [], [], 44)],
                  Node 44 [(Symb ")", [], [], 45)],
                  Node 45 [(Symb ")", [], [], 46)]]
...
listpropsLgraph = [Node 1 [(Symb ("Реализовать не рекурсивную функцию с атомом и списком в качестве параметров, которая возвращает исходный список, " ++
                   ...
                   Node 4 [(Symb "\nИначе возвращается список без изменений. ", [], [], 2)],
                   Node 5 [(Symb "(", [], [], 6)],
                   Node 6 [(Symb "DEFUN", [], [], 7)],
                   Node 7 [(Func 0, [], [], 8)],
                   Node 8 [(Symb "(", [], [], 9)],
