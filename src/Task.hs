...
arythmlistLgraph::[Node]
arythmlistLgraph = [Node 1 [(Symb "Реализовать рекурсивную функцию", [], [], 2)],
                    ...
                    Node 22 [(Symb "T", [], [], 23)],
                    Node 23 [(Symb "(", [], [], 24)],
                    Node 24 [(Symb "+", [], [Bracket '>' 3], 25),
                             (Symb "*", [], [Bracket '>' 4], 25)],
                    Node 25 [(Symb "(", [], [], 26)],
                    Node 26 [(Symb "CAR", [Bracket '(' 2], [], 27),
                             (Func 0, [Bracket '(' 1], [], 31)],
                    Node 27 [(Var 0, [], [], 28)],
                    Node 28 [(Symb ")", [], [], 29)],
                    Node 29 [(Symb "(", [], [], 30)],
